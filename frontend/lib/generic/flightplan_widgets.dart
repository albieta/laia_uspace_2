    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () async {
              dynamic flightplanCollisions = await container.read(getflightplanCollisionsProvider(Tuple2(widget.elementId ?? '', context)).future);
              setState(() {
          ...
          if (collisions != null && collisions!.isNotEmpty) 
            Text(
              "This Flight Plan should not be approved as there are possible collisions",
              style: TextStyle(
                fontStyle: FontStyle.italic,
                color: Color.fromARGB(255, 170, 86, 75),
              ),
            ),
          if (collisions != null && collisions!.isNotEmpty) 
            Container(
            ...
            if (collisions == null || collisions!.isEmpty) 
              Text(
                ...
                style: TextStyle(
                  fontStyle: FontStyle.italic,
                  color: Color.fromARGB(255, 110, 170, 75),
                ),
              ),
          ],
        ),
